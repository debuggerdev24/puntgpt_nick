...
class SubscriptionPlansScreen extends StatelessWidget {
  const SubscriptionPlansScreen({super.key, required this.provider});
  ...
  Widget planBox({required SubscriptionPlanModel plan}) {
    return Container(
            ...
            itemBuilder: (context, i) {
              ...
              return Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(features[i], style: regular(fontSize: 16.sp)),
                  ),
                ],
              );
            },
