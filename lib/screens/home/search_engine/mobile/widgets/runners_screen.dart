  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<SearchEngineProvider>(
      builder: (context, provider, child) {
        final runners = provider.runnerData?.runnersList;
        ...
        return Column(
          children: [
            Padding(
              padding: EdgeInsets.fromLTRB(25.w, 16.w, 25.w, 8.w),
              child: Row(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    ...
                                    "${runner.jumpTimeAu?.split(" ")[0] ?? '-'}.\n ${DateFormatter.formatTimeFromString(runner.jumpTimeAu).split(" ")[1]}. ",
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(width: 70.w, height: 16.h, color: Colors.white),
                      Container(width: 90.w, height: 16.h, color: Colors.white),
                    ],
                  ),
                ),
                // Divider
